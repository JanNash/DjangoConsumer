...
public extension DefaultImplementations.SinglePostable {
    public static func post<T: SinglePostable>(_ singlePostable: T, to node: OAuth2Node, additionalHeaders: HTTPHeaders, additionalParameters: Payload.JSON.Dict, conversion: PayloadConversion) {
